...
public class TrelloPostCard {

	public static void PostCard(String nomeB,String desc, String data,String idList, String key, String token) throws ClientProtocolException, IOException
	{
		//Inicia cliente HTTP
		...
		parametros.add(new BasicNameValuePair("due", data));
